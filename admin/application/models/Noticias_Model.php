...
class Noticias_Model extends CI_Model{
	...
	*/
	...
	public function select_Noticias($id = FALSE)
	{
	...
	public function insert_Noticias($preview, $archivo, $titulo, $id_autor, $descripcion, $contenido)
	{
		...
		$resultadoInsert = $this->db->insert('Noticias', $data); // 1 si fue exitoso
		return $this->db->insert_id(); // devuelve el id del nuevo elemento insertado
	}

	public function update_Noticias($id, $preview, $archivo, $titulo, $id_autor, $descripcion, $contenido)
	{
		$data = array(
			'preview' => $preview,
			'archivo' => $archivo,
	...
	public function delete_Noticias($id)
	{
		$this->db->where('id', $id);
