				...
				<div class="educar_item_half">
					...
					<div class="educar_detail_author_date">
						...
						<script>
							...
							$.ajax({
								type:"GET",
								url:"/revistauca/__controller/visitas_controller.php?numeroVisitas&id_elemento=" + <? echo $fila['id'] ?> + "&entidad=educar",
								success:function(responseText){console.log(responseText);
									$("#educar_item_<? echo $fila['id'] ?> #numeroVisitas").each(function(){
