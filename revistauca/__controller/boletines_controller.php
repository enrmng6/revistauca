				...
				<div class="boletines_item_half">
					...
					<div class="boletines_detail_author_date">
						...
						<script>
							...
							$.ajax({
								type:"GET",
								url:"/revistauca/__controller/visitas_controller.php?numeroVisitas&id_elemento=" + <? echo $fila['id'] ?> + "&entidad=boletines",
								success:function(responseText){
									$("#boletines_item_<? echo $fila['id'] ?> #numeroVisitas").each(function(){
