...
?>
  <td>
    <center><?= $carrera; ?></center>
        ...
        <td>
<br>
          <button type="button" name="button"><a href="<?=base_url("usuarios_controller/mod/$fila->id")?>"style="color: black; text-decoration:none;">Editar</a></button>
<hr><hr>

          <button type="button"  name="button"><a href="<?=base_url("usuarios_controller/eliminar/$fila->id")?>"style="color: black; text-decoration:none;">Eliminar</a></button>
