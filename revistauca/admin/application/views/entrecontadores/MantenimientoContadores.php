            ...
            <div class ="col-md-4">
                <div class ="panel panel-default">
                    ...
                    <div class ="panel-body">
                        <form action="<?=base_url('entrecontadores/guardar')?>" method="post">
                            ...
                            <div class ="col-md-12 text-center">
                                <a href="<?= base_url("entrecontadores/guardar")?>" class="btn btn-primary">Nuevo Registro</a>
                            ...
                            <tbody>
                                <?php
                                    ...
                                    foreach($entrecontadores as $entrecontadores){
                                        $rutaeditar = base_url("entrecontadores/guardar/{$entrecontadores['id']}");
                                        $rutaelimiar = base_url("entrecontadores/eliminar/eliminar?eliminar={$entrecontadores['id']}");
                                        echo"<tr>
